		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Cadastro de Usu&aacute;rios</h4>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-md-3">
							<a href="usuario.php" class="btn btn-primary btn-block">Adicionar
								Usu&aacute;rio</a>
						</div>
					</div>
							...
							<?php
								...
								$sql = 'select id, nome, email from usuarios ORDER BY nome';
									...
									foreach($pdo->query($sql)as $row)
									{
										...
										<a href="usuario.php?id='.$row['id'].'" class="btn btn-primary"><i class="fa fa-edit"></i></a>
