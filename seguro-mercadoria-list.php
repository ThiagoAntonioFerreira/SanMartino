        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Cadastro de Seguro de Mercadoria</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="seguro-mercadoria.php" class="btn btn-primary btn-block">Adicionar
                                Tipos</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table" id="myTable">
                            ...
                            <tbody>
                                ...
                                include 'banco.php';
                                $pdo = Banco::conectar();
                                $sql = 'select id, seguro_mercadoria from seguro_mercadoria ORDER BY seguro_mercadoria';

                                foreach ($pdo->query($sql) as $row) {
                                    echo '<tr>';
                                    echo '<td>' . $row['seguro_mercadoria'] . '</td>';
                                    echo '<td>
										<input type="hidden" value="' . $row['id'] . '" id="hfId" />
										<a href="seguro-mercadoria.php?id=' . $row['id'] . '" class="btn btn-primary"><i class="fa fa-edit"></i></a>
