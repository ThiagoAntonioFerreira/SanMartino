        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Cadastro de Escoltas</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="escolta.php" class="btn btn-primary btn-block">Adicionar
                                Escoltas</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table" id="myTable">
                            ...
                            <tbody>
								...
								include 'banco.php';
								$pdo = Banco::conectar();
								$sql = 'select id, escolta from escolta ORDER BY escolta';

								foreach ($pdo->query($sql) as $row) {
									echo '<tr>';
									echo '<td>' . $row['escolta'] . '</td>';
									echo '<td>
										<input type="hidden" value="' . $row['id'] . '" id="hfId" />
										<a href="escolta.php?id=' . $row['id'] . '" class="btn btn-primary"><i class="fa fa-edit"></i></a>
