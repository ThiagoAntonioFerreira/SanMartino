<?php
	...
	if (empty($_POST)) {
		...
		if ($id != ""){
			...
			$sql = "SELECT id, nome, email, senha FROM usuarios where id = ?";
			$q = $pdo->prepare($sql);
			$q->execute(array($id));
		...
		<div class="col-md-8">
			<div class="card card-user">
				<div class="card-header">
					<h5 class="card-title">Usu&aacute;rios</h5>
				</div>
				<div class="card-body">
					<form method="post">
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label>Nome:</label> 
									<input class="form-control" name="nome" value="<?php echo !empty($nome)?$nome:'';?>" required="required" placeholder="Nome">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label>Email:</label> 
									<input class="form-control" type="email" name="email" value="<?php echo !empty($email)?$email:'';?>" required="required" placeholder="E-mail">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label>Senha:</label> 
									<input class="form-control" type="password" name="senha" value="<?php echo !empty($senha)?$senha:'';?>" required="required" placeholder="Senha">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="update ml-auto mr-auto">
								...
								<a href="usuarios.php" class="btn btn-danger btn-round">Cancelar</a>
							</div>
						</div>
					</form>
				</div>
