...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05-Nov-2020 às 15:54
...
--
-- Banco de dados: `sanmartino`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `carga_descargas`
--

CREATE TABLE `carga_descargas` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `carga_descarga` varchar(244) NOT NULL
...
(1, 'adsf', 'adf', 'adsf adsf ad@gmail');

-- --------------------------------------------------------

--
-- Estrutura da tabela `escolta`
--

CREATE TABLE `escolta` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `escolta` varchar(244) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `mercadorias` (`id`, `mercadoria`) VALUES
(1, 'asdf'),
(2, 'opa');
...
CREATE TABLE `orcamentos` (
  ...
  `escolta` varchar(128) NOT NULL,
  `tipo_carregamento` varchar(128) NOT NULL,
  `observacoes` text NOT NULL,
  `validade_proposta` varchar(244) NOT NULL,
  `icms_cond` varchar(244) NOT NULL,
  `seguro_merc` varchar(244) NOT NULL,
  `carg_desc` varchar(244) NOT NULL,
  `cond_veiculos` varchar(244) NOT NULL,
  `carregamento` varchar(244) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `orcamentos` (`id`, `id_cliente`, `data`, `id_servico`, `id_mercadoria`, `escolta`, `tipo_carregamento`, `observacoes`, `validade_proposta`, `icms_cond`, `seguro_merc`, `carg_desc`, `cond_veiculos`, `carregamento`) VALUES
(1, 1, '0000-00-00 00:00:00', 2, 2, 'Não se aplica', 'solto', '', '12 meses', 'Conforme legislação vigente', 'Por conta do Cliente', 'Por conta da San Martino, e averbaçao eletronica SEFAS', 'Todos os veículos conforme leis e normas ANTT, as emissoes de CO² esta dentro do minimo exigido conforme leis ambientais', 'wsadas'),
(2, 1, '2020-10-14 11:50:46', 1, 2, 'Não se aplica', 'BIG BAG', '', '12 meses', 'Conforme legislação vigente', 'Por conta do Cliente', 'Por conta da San Martino, e averbaçao eletronica SEFAS', 'Todos os veículos conforme leis e normas ANTT, as emissoes de CO² esta dentro do minimo exigido conforme leis ambientais', 'dgf');

-- --------------------------------------------------------

--
-- Estrutura da tabela `seguro_mercadoria`
--

CREATE TABLE `seguro_mercadoria` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `seguro_mercadoria` varchar(244) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Mão de obra'),
(2, 'adsf adsf adfa sdf');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tipo_veiculos`
--

CREATE TABLE `tipo_veiculos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `tipo_veiculo` varchar(244) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura da tabela `valores_orcamento`
--

CREATE TABLE `valores_orcamento` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `id_orcamento` int(24) NOT NULL,
  `origem` varchar(244) NOT NULL,
  `destino` varchar(244) NOT NULL,
  `tipo_veiculo` varchar(244) NOT NULL,
  `frete_peso` varchar(244) NOT NULL,
  `gris` varchar(244) NOT NULL,
  `adv` varchar(244) NOT NULL,
  `pedagio` varchar(244) NOT NULL,
  `icms` varchar(244) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Índices para tabela `carga_descargas`
--
ALTER TABLE `carga_descargas`
...
--
-- Índices para tabela `seguro_mercadoria`
--
ALTER TABLE `seguro_mercadoria`
  ADD UNIQUE KEY `id` (`id`);
...
--
-- Índices para tabela `tipo_veiculos`
--
ALTER TABLE `tipo_veiculos`
  ADD UNIQUE KEY `id` (`id`);
...
--
-- Índices para tabela `valores_orcamento`
--
ALTER TABLE `valores_orcamento`
  ADD UNIQUE KEY `id` (`id`);
...
--
-- AUTO_INCREMENT de tabela `carga_descargas`
--
ALTER TABLE `carga_descargas`
...
--
-- AUTO_INCREMENT de tabela `escolta`
--
ALTER TABLE `escolta`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `seguro_mercadoria`
--
ALTER TABLE `seguro_mercadoria`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tipo_veiculos`
--
ALTER TABLE `tipo_veiculos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `valores_orcamento`
--
ALTER TABLE `valores_orcamento`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
