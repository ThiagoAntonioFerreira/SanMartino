		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Cadastro de Mercadorias</h4>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-md-3">
							<a href="mercadoria.php" class="btn btn-primary btn-block">Adicionar
								Mercadorias</a>
						</div>
					</div>
					<div class="table-responsive">
						<table class="table" id="myTable">
							...
							<?php
								include 'banco.php';
								$pdo = Banco::conectar();
								$sql = 'select id, mercadoria from mercadorias ORDER BY mercadoria';
									...
									foreach($pdo->query($sql)as $row)
									{
										...
										<a href="mercadoria.php?id='.$row['id'].'" class="btn btn-primary"><i class="fa fa-edit"></i></a>
